    ...
    calculate(input) {
        ...
        if (!changed) {
            if (this.state.zoom > this.maxZoom && state.zoom > this.maxZoom) ;
                ...
                changed = changed || !fast_deep_equal_default()(this.state, state);
            }
        }
        this.state = state;
        if (changed) {
...
var openList = document.querySelector(".site-list__item--open");
...
var videoBtn = document.querySelector(".video__mute-btn");
